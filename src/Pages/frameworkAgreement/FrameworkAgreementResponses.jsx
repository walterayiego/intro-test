...
const FrameworkAgreementResponses = () => {
  ...
  return (
    ...
    <div className='flex'>
      ...
      <div className='px-[10px] basis-[88%] h-[100vh] overflow-scroll bg-[#EAEFF2] '>
        ...
        <Link to="/prequalifications" className='text-[#0437F2]  px-[20px] py-[15px] text-3xl font-bold flex items-center '>Framework Agreement< MdKeyboardArrowRight size={30} className=' font-bold text-[#0437F2]' /> Responses </Link>
        <div className=" p-4">
                   ...
                   <li key={prequalification.id} className="">  
                           <div className='w-full p-[20px] '>
                              <div className='bg-[#F5F5F5F5] my-4 rounded-md shadow-md'>
                                  <Link to ="/prequalificationresponseId" className=''>
                                     ...
                                     <div className=' p-[20px] basis-[30%]'>
                                       <div>
                                           <div className='ml-[150px]'>
                                                  ...
                                                  <h2 className='text-[17px] mt-[15px] flex items-center font-medium text-blue-700'>Status:<span className='text-green-500'>Awaiting Review</span></h2>
                                           </div>
...
export default FrameworkAgreementResponses