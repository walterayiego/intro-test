    ...
    <div>
      <div className='flex'>
        ...
        <div className='px-[10px] basis-[88%] h-[100vh] overflow-scroll bg-[#EAEFF2]  '>
          <DashboardView  />
           <div className=''>
             <h2 className='text-3xl text-[#3b3bff] font-bold my-[25px]'>Purchase Order</h2>
              <div className='flex  w-full justify-between '>
                <div className='bg-[#E8E9EB] w-[850px]  shadow-md rounded-md'>
                   <Link to="/purchaseorderresponses1" className='p-[20px]'>
                      <h3 className='text-black/75   text-right  px-[20px] font-bold'>Check Responses<span className='text-blue-500'>(8)</span></h3>
                       <h2 className='text-blue-700 text-xl mt-[35px]  px-[20px] font-bold '>Purchase Order Responses</h2>
                   </Link >
                </div>
                <div className='basis-[35%]  ml-[60px] flex flex-col justify-between '>
                     <Link to="/purchaseorderresponses2" className='bg-black/75 w-[420px] py-[15px] rounded-xl text  items-center flex justify-center text-white'> View Pre-qualified Suppliers</Link>
           ...
           <div className='my-[30px] '>
                   <h2 className='text-blue-700 text-3xl font-bold'>Received Purchase Orders</h2>
                 </div>
